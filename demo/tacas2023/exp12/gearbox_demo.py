...
if __name__ == "__main__":
    ...
    bench.scenario.set_init([[[-0.0168, 0.0029, 0, 0, 0], [-0.0166, 0.0031, 0, 0, 0]]], [tuple([AgentMode.Free])])
    if 'b' in bench.config.args:
        ...
        run()
        bench.scenario.set_init([[[-0.0168, 0.0030, 0, 0, 0], [-0.0166, 0.0032, 0, 0, 0]]], [tuple([AgentMode.Free])])
        run(True)
